...
def run_test_practice_problem2a():
    ...
    # Test 1
    expected = [-2, 0, 1, 2, 4]
    actual = practice_problem2a([1, 3, 4, 5, 7], -3)
    print('TEST 1')
    ...
    # Test 2
    expected = [10, 18, 102, 64, 16]
    actual = practice_problem2a([0, 8, 92, 54, 6], 10)
    print('TEST 2')
    print('Expected:', expected)
    print('Actual:  ', actual)
    print()
    ...
    # Test 3
    expected = [195]
    actual = practice_problem2a([1], 194)
    print('TEST 3')
    print('Expected:', expected)
    print('Actual:  ', actual)
    print()
    ...
    # Test 4
    expected = [2, -7, 9, 12, 24, 3]
    actual = practice_problem2a([-3, -12, 4, 7, 19, -2], 5)
    print('TEST 4')
    print('Expected:', expected)
    print('Actual:  ', actual)
    print()
    ...
    # Test 5
    expected = [-3, -12, 4, 7, 19, -2]
    actual = practice_problem2a([-3, -12, 4, 7, 19, -2], 0)
    print('TEST 5')
    print('Expected:', expected)
    print('Actual:  ', actual)
    print()
...
def practice_problem2b(sequence):
    ...
    new_string = ''
    for k in range(len(sequence)):
        current_word = sequence[k]
        if current_word != '':
            new_string = new_string + current_word[0]
    return new_string
